...
router.get("/api/game/truth", cekKey, async (req, res, next) => {
  limitapikey(req.query.apikey);
  scr.truth().then((data) => {
    let result = data;
    res.json({
...
router.get("/api/game/dare", cekKey, async (req, res, next) => {
  limitapikey(req.query.apikey);
  scr.dare().then((data) => {
    let result = data;
    res.json({
...
router.get("/api/maker/darkness", cekKey, async (req, res) => {
  ...
  if (!n)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] parameter no nombor sahaja",
    });
...
router.get("/api/maker/resize", cekKey, async (req, res) => {
  ...
  if (!width)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] masukan parameter width",
    });
  if (!height)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] masukan parameter height",
    });
  ...
  if (!wid)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] parameter width nombor sahaja",
    });
  if (!hei)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] parameter height nombor sahaja",
    });
...
router.get("/api/maker/welcome1", cekKey, async (req, res, next) => {
  ...
  if (!name)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] masukan parameter name",
    });
  if (!grup)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] masukan parameter gpname",
    });
  if (!member)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] masukan parameter member",
    });
  if (!pp)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] masukan parameter pp",
    });
  if (!bg)
    return res.json({
      status: false,
  ...
  if (!imgpp)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] cek kembali url image pp",
    });
  if (!bgimg)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] cek kembali url image bg",
    });
...
router.get("/api/maker/goodbye1", cekKey, async (req, res, next) => {
  ...
  if (!imgpp)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] masukan parameter pp Link pp dengan betul",
    });
  if (!bgimg)
    return res.json({
      status: false,
      creator: `${creator}`,
      message: "[!] masukan parameter pp Link bg dengan betul",
    });
...
router.get("/api/info/infogempabmkg", cekKey, async (req, res) => {
  let data = await fetchJson(
